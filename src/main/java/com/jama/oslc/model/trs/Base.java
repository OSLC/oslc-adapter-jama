...
@OslcResourceShape(title = "Tracked Resource Set Base  Shape", describes = TRSConstants.TRS_TYPE_BASE)
public class Base extends AbstractResource {
	 ...
	 * @return the nextPage
	 */
	@OslcName(TRSConstants.TRS_TERM_NEXT_PAGE)
	...
	@OslcPropertyDefinition(TRSConstants.TRS_NEXT_PAGE)
	@OslcTitle("Next Page")
