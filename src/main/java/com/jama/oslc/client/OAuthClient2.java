...
public class OAuthClient2 {
	...
	public static void main(String[] args) {
		String baseUrl = "http://demo.koneksys.com/jama-oslc-adapter/services/";		
		...
		try {
			ClientResponse clientResponse = oslcOAuthClient.getResource("http://demo.koneksys.com/jama-oslc-adapter/services/serviceProviderCatalog", OSLCConstants.CT_RDF);
